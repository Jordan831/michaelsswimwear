...
export function Layout({children, layout}) {
  const {headerMenu, footerMenu,footerMenusecond} = layout;
  ...
  return (
    <>
      ...
      {<Footer menu={footerMenu} menusecond={footerMenusecond} />}
    </>
  );
}
...
function Footer({menu,menusecond}) {
  const isHome = useIsHomePath();
...
<footer
  ...
  <div
    ...
    <div className="flex justify-center">
      ...
      <a href="https://www.facebook.com/MichaelsSwimwear" className="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
      ...
      <a href="https://twitter.com/michaelswimwear" className="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4"
          fill="currentColor"
      ...
      <a href="https://www.instagram.com/michaelswimwear/" className="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-4 w-4"
          fill="currentColor"
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid-cols-1 grid gap-8 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4">
      ...
      <div className="">
        ...
        (menusecond?.items || []).map((item,index) => (<p key={index}>
          <a href={item.to}  className="text-neutral-600 dark:text-neutral-200">{item.title}</a>
        </p>)) }
      ...
      <div className="">
        ...
        {
        (menu?.items || []).map((item,index) => (<p key={index}>
          <a href={item.to}  className="text-neutral-600 dark:text-neutral-200">{item.title}</a>
        </p>)) }
      </div>
      ...
      <div>
        ...
        <p className="mb-4 flex items-center justify-center md:justify-start">
          ...
          Customersupport@michaelsswimwear.com
        </p>
        <p className="mb-4 flex items-center justify-center md:justify-start">
          <svg
            xmlns="http://www.w3.org/2000/svg"
  ...
  <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
    ...
    <a
      ...
      href="/"
      >Designed & Developed By Build Grow Scale</a>
  </div>
</footer>
  );
}
